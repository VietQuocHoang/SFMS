    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
            .authorizeRequests()
                ...
                .mvcMatchers("/modify-feedback/**").access("hasAuthority('EDIT_PERMISSION') or hasAuthority('EDIT_FEEDBACK')")
                ...
                .and()
                .formLogin().loginPage("/login").failureHandler(new CustomizeAuthenticationFailureHandler())
