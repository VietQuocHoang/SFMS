...
public class Department {
    ...
    private int id;
    @JsonView({TargetView.basicClazzView.class, TargetView.basicDepartmentView.class, UserView.listUserView.class, FeedbackView.listView.class, UserView.listLecturerView.class})
    private String name;
